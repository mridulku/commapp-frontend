  ...
  return (
    <Box
      ...
      sx={{
        ...
        boxSizing: "border-box",      // ← border now counted inside 100 %
        borderRadius: 2,
        display: "flex",
...
{selected && (
  <Box
    sx={{
      ...
      right: 6,            // snug against the border
  ...
  >
    <ArrowRightAltIcon sx={{ fontSize: 18, color: "#000" }} />
      ...
      {meta.label !== "Read" && <Box sx={{ flex: 1 }} />}

      {/* progress – only for quizzes */}
      {meta.label !== "Read" && (
        <>
          <LinearProgress
            variant="determinate"
