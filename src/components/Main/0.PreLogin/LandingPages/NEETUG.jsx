...
/* sections */
import LearnerJourney from "./NEETUGSupport/LearnerJourney";   // ⬅️ NEW

import NavBar from "./NEETUGSupport/NavBar";
import Hero from "./NEETUGSupport/Hero";
import EngineLayers from "./NEETUGSupport/EngineLayers";
import ToolsGallery from "./NEETUGSupport/ToolsGallery";      // ⬅️ NEW
import WhyDifferentTable from "./NEETUGSupport/WhyDifferentTable";
import ProofCTA from "./NEETUGSupport/ProofCTA";
