// -------------------------------------------------------------
// /src/components/MaterialsDashboard.jsx      (v2 with Loader)
// -------------------------------------------------------------
...
import PlanSelector from "../1.SelectionPanel/PlanSelector";
...
export default function MaterialsDashboard({
  ...
  const [loadingPlans,   setLoadingPlans]   = useState(false);   // ← NEW
 ...
 <Grid item xs={12} md={4} lg={3}
        sx={{ /* borderRight:"1px solid #333" */ }}>   {/* no bgcolor */} 
          <PlanSelector
            planIds={planIds}
